...
- (void)showInView:(UIView *)view {
    ...
    bacView.frame = CGRectMake(0, -64, view.frame.size.width, view.frame.size.height + 64);
    bacView.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.3];
...
//    self.alpha = 0;
    ...
    [view addSubview:bacView];
     ...
     //[bacView bringSubviewToFront:view];
