...
//    _addBtn.layer.borderColor = ME_COLOR_666666.CGColor;
//    _addBtn.layer.borderWidth = 1.0f;
//    
//    _reducBtn.layer.borderColor = ME_COLOR_666666.CGColor;
//    _reducBtn.layer.borderWidth = 1.0f;
    
//    _changeCountField.layer.borderColor = ME_COLOR_666666.CGColor;
...
//    _changeShopDetailView.frame = FRAMEMAKE_F(CGRectGetMaxX(_shopImageView.frame), 30, WIDTH_K / 2, 20);
...
- (void)setShopCellEditState:(BOOL)shopCellEditState{
    ...
    _shopPriceLabel.hidden = shopCellEditState;
    _shopNameLabel.hidden = shopCellEditState;
    _addBtn.hidden = !shopCellEditState;
    _changeCountField.hidden = !shopCellEditState;
    _reducBtn.hidden = !shopCellEditState;
   
    if (shopCellEditState == YES) {
        _bottom.constant = 15;
        [_changeShopDetailView layoutIfNeeded];
      
        
    }else{
        
        _bottom.constant = 44.5;
        [_changeShopDetailView layoutIfNeeded];
