...
@implementation ShopPreViewCell
...
- (void)setShop:(NSString *)shop substract:(NSString *)substract discount:(NSString *)discount{
    ...
    LabelSet(_shopLabel, shop, ME_COLOR_666666, 15, moreDic, moreSize);
    
    _shopLabel.frame = FRAMEMAKE_F(15, ViewFromX_Y * 2, moreSize.width, moreSize.height);
